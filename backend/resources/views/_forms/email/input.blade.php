    ...
    <div class="input-group content">
        <button class="btn btn-secondary" disabled>
            ...
            <span class="svg-icon svg-icon-muted svg-icon-2">
                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Communication/Mail-at.svg--><svg
        ...
        <input type="email" name="{{ $data['name'] }}"
            class="form-control @if ($errors->has($data['name'])) is-invalid @endif email"
