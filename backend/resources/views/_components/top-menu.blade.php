        ...
        <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                ...
                <span class="menu-link">
                    <span class="menu-title">{{ __(ucwords(request()->segment(1))) }}</span>
    ...
    <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                ...
                <div class="menu-item px-5">
                    <a href="{{ url('user/reset_password') }}" class="menu-link px-5">Update Password</a>
                </div>
                <div class="separator my-2"></div>
                <div class="menu-item px-5" data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                    ...
                    <a href="#" class="menu-link px-5">
                        <span class="menu-title position-relative">{{ __('Language') }}
                            <span
                                class="fs-8 rounded bg-light px-3 py-2 position-absolute translate-middle-y top-50 end-0">{{ strtoupper(App::getLocale()) }}
                ...
                <form action="{{ url('logout') }}" class="menu-item px-5" id="logout-form" method="POST">
                    @method('POST')
                    @csrf
                    <a class="menu-link px-5" onclick="$('#logout-form').submit()">Sign Out</a>
                </form>
            </div>
        </div>
