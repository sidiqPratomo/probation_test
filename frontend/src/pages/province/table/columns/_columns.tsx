...
const usersColumns: ReadonlyArray<Column<any>> = [
  ...
  {
    Header: (props) => <CustomHeader tableProps={props} title='Province id' className='min-w-125px' />,
    id: 'id',
    Cell: ({...props}) => {
  ...
  {
    Header: (props) => <CustomHeader tableProps={props} title='Province Name' className='min-w-125px' />,
    id: 'name',
    Cell: ({...props}) => {
      const entry = props.data[props.row.index]
